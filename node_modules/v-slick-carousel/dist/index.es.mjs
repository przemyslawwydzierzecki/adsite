import { defineComponent as ye, computed as j, unref as Se, renderSlot as ie, normalizeProps as ue, mergeProps as se, createElementVNode as de, normalizeClass as le, toDisplayString as Oe, openBlock as W, createElementBlock as P, normalizeStyle as Ee, Fragment as Q, renderList as K, createBlock as ne, resolveDynamicComponent as Te, useSlots as Pt, ref as X, getCurrentInstance as Ht, watch as re, onMounted as jt, onUpdated as Bt, onBeforeUnmount as _t, withCtx as xe, guardReactiveProps as Ie, createCommentVNode as Ce, createVNode as Vt } from "vue";
var T = /* @__PURE__ */ ((e) => (e.play = "play", e.playing = "playing", e.paused = "paused", e.hovered = "hovered", e.focused = "focused", e.update = "update", e.leave = "leave", e.blur = "blur", e))(T || {}), pt = /* @__PURE__ */ ((e) => (e.ondemand = "ondemand", e.progressive = "progressive", e))(pt || {}), R = /* @__PURE__ */ ((e) => (e.left = "left", e.right = "right", e.up = "up", e.down = "down", e.vertical = "vertical", e))(R || {}), H = /* @__PURE__ */ ((e) => (e.next = "next", e.previous = "previous", e))(H || {}), oe = /* @__PURE__ */ ((e) => (e.auto = "auto", e.manual = "manual", e))(oe || {});
const $e = (e) => e.flatMap(
...
const Ft = (e, r, t) => {
  ...
  if (u = f % v !== 0, t = u ? 0 : (f - p) % v, r.message === H.previous)
    ...
    return null;
  return s;
}, qt = (e) => e.targetSlideGroupIndex > e.currentSlideGroupIndex ? e.targetSlideGroupIndex > e.currentSlideGroupIndex + Yt(e) ? "left" : "right" : e.targetSlideGroupIndex < e.currentSlideGroupIndex - Ut(e) ? "right" : "left", Yt = ({
  groupsToShow: e,
  centerMode: r,
  rtl: t,
  centerPadding: i
  ...
  if (Array.from(a).every((f) => {
    ...
    return 0;
  const u = e.rtl === !0 ? e.slideGroupCount - e.currentSlideGroupIndex : e.currentSlideGroupIndex, s = (k = t == null ? void 0 : t.dataset) == null ? void 0 : k.index;
  return Math.abs(
    s ? parseInt(s) : 0 - u
  );
}, vt = (e, r = !1) => {
  let t, i, a, u;
  return t = e.startX - e.curX, i = e.startY - e.curY, a = Math.atan2(i, t), u = Math.round(a * 180 / Math.PI), u < 0 && (u = 360 - Math.abs(u)), u <= 45 && u >= 0 || u <= 360 && u >= 315 ? R.left : u >= 135 && u <= 225 ? R.right : r === !0 ? u >= 35 && u <= 135 ? R.up : R.down : R.vertical;
}, Zt = (e, r) => {
  const {
    dragging: t,
    swipe: i,
...
function fe(e) {
  ...
  if (h || s === 1)
    return 0;
  let D = 0;
  if (a ? (D = -Z(e), s % k !== 0 && t + k > s && (D = -(t > s ? v - (t - s) : s % k)), u && (D += Math.floor(v / 2))) : (s % k !== 0 && t + k > s && (D = v - s % k), u && (D = Math.floor(v / 2))), M = D * parseInt(`${f}`), B = D * parseInt(`${S}`), y ? g = t * parseInt(`${S}`) * -1 + B : g = t * parseInt(`${f}`) * -1 + M, c === !0) {
    let A;
    if (A = t + Z(e), C = i && i.childNodes[A], g = C ? C.offsetLeft * -1 : 0, u === !0) {
...
const rr = (e) => e.infinite || e.currentSlideGroupIndex !== 0 && e.slideGroupCount > e.groupsToShow, je = (e) => {
  let r = !0;
...
const ir = (e, r) => {
  ...
  return M || (k === 0 && q === "right" || k + 1 >= we && q === "left" || !je(r) && q === "left") && (Y = Math.round(g.swipeLength * f), p === !1 && c && (c(q), b.edgeDragged = !0)), !S && C && (C(q), b.swiped = !0), a ? A = $ + Y * (B / D) * _ : v ? A = $ - Y * _ : A = $ + Y * _, s && (A = $ + Y * _), b = {
    ...b,
    touchObject: g,
    swipeLeft: A,
    trackStyle: ce(r, A)
  }, Math.abs(g.curX - g.startX) < Math.abs(g.curY - g.startY) * 0.8 || g.swipeLength > 10 && (b.swiping = !0, e.preventDefault()), b;
};
function yt(e, r) {
...
const lr = () => !!(typeof window < "u" && window.document && window.document.createElement), lt = (e) => Object.keys(e).filter((r) => e[r] !== void 0).reduce((r, t) => (r[t] = e[t], r), {});
function ar() {
  var e, r;
...
}, ze = me(), ur = Object.keys(ze).reduce((e, r) => (e[r] = ze[r].default, e), {}), sr = () => ({
  animating: !1,
  autoplaying: null,
  autoplayTimer: null,
  currentDirection: 0,
...
var yr = Ne, mr = yr, _e = mt, wr = _e.each, at = _e.isFunction, Gr = _e.isArray;
function De() {
...
var kr = De, br = kr, Tr = new br();
const xr = /* @__PURE__ */ Be(Tr);
var Ir = function(e) {
  return e.replace(/[A-Z]/g, function(r) {
    return "-" + r.toLowerCase();
  }).toLowerCase();
}, Cr = Ir, Lr = Cr, Mr = function(e) {
  var r = /[height|width]$/;
  return r.test(e);
}, ut = function(e) {
  ...
  return t.forEach(function(i, a) {
    var u = e[i];
    i = Lr(i), Mr(i) && typeof u == "number" && (u = u + "px"), u === !0 ? r += i : u === !1 ? r += "not " + i : r += "(" + i + ": " + u + ")", a < t.length - 1 && (r += " and ");
  }), r;
}, Or = function(e) {
  var r = "";
...
const st = /* @__PURE__ */ Be(Er), $r = /* @__PURE__ */ ye({
  __name: "VSlickArrow",
  props: cr,
  ...
  setup(e, { emit: r }) {
    ...
    return (s, v) => s.type === Se(H).previous ? ie(s.$slots, "prevArrow", ue(se({ key: 0 }, u.value)), () => [
      de("button", {
        type: "button",
        "data-role": "none",
        class: le(["v-slick-arrow prev", { disabled: s.disabled }]),
        onClick: v[0] || (v[0] = //@ts-ignore
        (...k) => a.value && a.value(...k))
      }, Oe(s.prevArrowLabel), 3)
    ], !0) : ie(s.$slots, "nextArrow", ue(se({ key: 1 }, u.value)), () => [
      de("button", {
        type: "button",
        "data-role": "none",
        class: le(["v-slick-arrow next", { disabled: s.disabled }]),
        onClick: v[1] || (v[1] = //@ts-ignore
        (...k) => a.value && a.value(...k))
      }, Oe(s.nextArrowLabel), 3)
    ], !0);
  }
}), Ve = (e, r) => {
  ...
  for (const [i, a] of r)
    t[i] = a;
  return t;
}, dt = /* @__PURE__ */ Ve($r, [["__scopeId", "data-v-ef343262"]]), Wr = ["onClick"], zr = ["onClick"], Ar = ["onClick"], Nr = /* @__PURE__ */ ye({
  __name: "VSlickTrack",
  props: dr,
  emits: ["childClick"],
  setup(e, { emit: r }) {
    const t = e, i = r, a = (f) => {
      let p = !1, c = !1, S = !1, h;
      return t.centerMode ? (h = Math.floor(t.groupsToShow / 2), c = (f - t.currentSlideGroupIndex) % t.slideGroupCount === 0, f > t.currentSlideGroupIndex - h - 1 && f <= t.currentSlideGroupIndex + h && (p = !0)) : p = t.currentSlideGroupIndex <= f && f < t.currentSlideGroupIndex + t.groupsToShow, S = f === t.currentSlideGroupIndex, Object.entries({
        active: p,
        center: c,
        current: S
      }).filter(([, y]) => y).map(([y]) => y);
    ...
    })), v = j(() => !t.infinite || t.fade || t.slideGroupCount <= t.groupsToShow ? [] : t.rawSlideGroups.map((p, c) => {
    ...
    }).filter((p) => p)), k = j(() => !t.infinite || t.fade || t.slideGroupCount <= t.groupsToShow ? [] : t.rawSlideGroups.map((p, c) => {
    ...
    return (f, p) => (W(), P("div", {
      class: le(["v-slick-track", { center: f.centerMode, vertical: f.vertical }]),
      style: Ee([f.trackStyle, f.detectingWidth ? { width: "0 !important" } : {}])
    }, [
      (W(!0), P(Q, null, K(v.value, (c, S) => (W(), P("div", se({
        key: c.key,
        tabindex: "-1",
        ...
        (W(!0), P(Q, null, K(c.slides, (h, y) => (W(), ne(Te(h), {
          key: `slide-${S}-${y}` + (h.key ? `-${String(h.key)}` : "")
        }))), 128))
      ], 16, Wr))), 128)),
      (W(!0), P(Q, null, K(s.value, (c, S) => (W(), P("div", se({
        key: c.key,
        tabindex: "-1",
      ...
      (W(!0), P(Q, null, K(k.value, (c, S) => (W(), P("div", se({
        key: c.key,
        tabindex: "-1",
        class: [c.class, "v-slick-slide-group clone"],
        style: c.style,
...
}), Dr = /* @__PURE__ */ Ve(Nr, [["__scopeId", "data-v-5a37399b"]]), Pr = ["onClick"], Hr = /* @__PURE__ */ ye({
  __name: "VSlickDots",
  props: fr,
  ...
  setup(e) {
    ...
    return (i, a) => (W(), P("ul", {
      class: le(i.dotsClass),
      style: { display: "block" },
      onMouseenter: a[0] || (a[0] = (u) => i.$emit("dotsLeave")),
      onMouseleave: a[1] || (a[1] = (u) => i.$emit("dotsLeave")),
      onMouseover: a[2] || (a[2] = (u) => i.$emit("dotsOver"))
    }, [
      (W(!0), P(Q, null, K(i.pageCount, (u) => (W(), P("li", {
        key: u,
        class: le({ active: t(u - 1) }),
        onClick: (s) => i.$emit("dotClick", {
          index: u - 1,
          groupsToScroll: i.groupsToScroll
        })
      }, [
        ie(i.$slots, "customPaging", {
          page: u - 1
        }, () => [
          de("button", null, Oe(u), 1)
        ])
      ], 10, Pr))), 128))
    ], 34));
  }
});
var jr = "Expected a function", ct = NaN, Br = "[object Symbol]", _r = /^\s+|\s+$/g, Vr = /^[-+]0x[0-9a-f]+$/i, Rr = /^0b[01]+$/i, Fr = /^0o[0-7]+$/i, Xr = parseInt, qr = typeof ge == "object" && ge && ge.Object === Object && ge, Yr = typeof self == "object" && self && self.Object === Object && self, Ur = qr || Yr || Function("return this")(), Qr = Object.prototype, Kr = Qr.toString, Zr = Math.max, Jr = Math.min, Me = function() {
  return Ur.Date.now();
};
function eo(e, r, t) {
  var i, a, u, s, v, k, f = 0, p = !1, c = !1, S = !0;
...
var oo = eo;
const io = /* @__PURE__ */ Be(oo), no = ["dir"], lo = 50, ao = /* @__PURE__ */ ye({
  inheritAttrs: !1,
  ...
  setup(e, { expose: r, emit: t }) {
    var tt, rt, ot;
    const i = e, a = t, u = Pt(), s = lr() ? xr : void 0;
    let v, k = null, f = null, p = [];
    const c = X({
      ...((ot = (rt = (tt = Ht()) == null ? void 0 : tt.vnode) == null ? void 0 : rt.props) == null ? void 0 : ot.style) || {}
    });
    let S = !0, h = null, y = null, x = [];
    const M = (o, l) => {
      ...
      l && (l.swiping && (S = !1), Object.assign(d.value, l));
    }, b = () => {
      let o;
      if (n.value.rtl)
      ...
      S === !1 && (o.stopPropagation(), o.preventDefault()), S = !0;
    }, wt = ({ index: o }) => {
    ...
    }, Qe = async () => (d.value.detectingWidth = !0, new Promise(
      (o) => setTimeout(() => {
        var l;
        Object.assign(Ze.value, {
          width: `${(l = Ke.value) == null ? void 0 : l.offsetWidth}px`
        }), d.value.detectingWidth = !1, o();
      })
    )), Wt = () => {
      const o = {
        ...n.value,
      ...
      ), l.groupsToScroll = 1), l.fade && (l.groupsToShow > 1 && process.env.NODE_ENV !== "production" && console.warn(
      ...
      ), l.groupsToShow = 1, l.groupsToScroll = 1), l.slidesPerGroup > 1 && (l.variableWidth && process.env.NODE_ENV !== "production" && console.warn("slidesPerGroup is bigger than 1: variableWidth is disabled"), l.variableWidth = !1), l.vertical && l.rtl && (process.env.NODE_ENV !== "production" && console.warn("vertical mode is enabled: rtl is disabled"), l.rtl = !1), l;
    }), Je = j(
      () => rr({
        ...n.value,
        ...d.value,
    ...
    return re(
      ...
      var o;
      window.addEventListener("resize", Ue), n.value.widthDetection === oe.manual && await Qe(), Ge(!0), _(), n.value.autoplay && N(T.update), n.value.lazyLoad === pt.progressive && (f = setInterval(Et, 1e3)), y = new ResizeObserver(() => {
        d.value.animating ? (ee({ shouldSetTrackStyle: !1 }), p.push(setTimeout(() => ee(), n.value.speed))) : ee();
    ...
    }), C(), Wt(), a("init"), (o, l) => (W(), P("div", {
      ref_key: "vSlickCarouselRef",
      ref: Ke,
      class: "v-slick-carousel",
      style: Ee(
        o.widthDetection === Se(oe).manual ? d.value.detectingWidth ? { width: "100%" } : Ze.value : {}
      )
    }, [
      de("div", {
        ...
        n.value.arrows ? (W(), ne(dt, {
          ...
          prevArrow: xe((m) => [
            ie(o.$slots, "prevArrow", ue(Ie(m)), void 0, !0)
          ]),
          _: 3
        }, 8, ["type", "center-mode", "infinite", "groups-to-show", "slide-group-count", "current-slide-group-index", "disabled"])) : Ce("", !0),
        de("div", {
          ref_key: "vSlickListRef",
          ref: O,
          class: le(["v-slick-list", { dragging: d.value.dragging }]),
          style: Ee(c.value),
          onClick: Y,
          onMousedown: Re,
        ...
        n.value.arrows ? (W(), ne(dt, {
          ...
          nextArrow: xe((m) => [
            ie(o.$slots, "nextArrow", ue(Ie(m)), void 0, !0)
          ]),
          _: 3
        }, 8, ["type", "center-mode", "infinite", "groups-to-show", "slide-group-count", "current-slide-group-index", "disabled"])) : Ce("", !0)
      ], 8, no),
      n.value.dots ? (W(), ne(Hr, {
        key: 0,
        "current-slide-group-index": d.value.currentSlideGroupIndex,
        infinite: n.value.infinite,
        "slide-group-count": E.value,
        ...
        customPaging: xe((m) => [
          ie(o.$slots, "customPaging", ue(Ie(m)), void 0, !0)
        ]),
        _: 3
      }, 8, ["current-slide-group-index", "infinite", "slide-group-count", "groups-to-scroll", "groups-to-show", "dots-class", "page-count"])) : Ce("", !0)
    ], 4));
  }
}), so = /* @__PURE__ */ Ve(ao, [["__scopeId", "data-v-b4e52e3f"]]);
export {
  pt as LazyLoadType,
  T as PlayingType,
